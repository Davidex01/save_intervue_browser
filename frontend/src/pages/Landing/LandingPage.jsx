        ...
        <Container className="landing-hero__inner">
          <div className="landing-hero__content">
            ...
            <p className="landing-hero__subtitle">
              ...
              адаптивные задачи, безопасное выполнение кода и
        ...
        <div className="landing-grid__col">
          <ul className="landing-list">
            ...
            <li className="landing-list__item">
              ...
              <p>
                Задачи рассчитаны на 10–25 минут и позволяют показать реальные
            ...
            <li className="landing-list__item">
              ...
              <p>
                После завершения вы видите отчет по интервью после анализа LLM-моделью.
              </p>
            </li>
          </ul>
        </div>
    ...
    >
      <div className="landing-grid landing-grid--3">
        <div className="landing-card">
          <h3>Объективные оценки от LLM-модели</h3>
          <p>
    ...
    >
      <ol className="steps-list">
        <li>
          ...
          <p>
            ИИ выдаёт задачи, чтобы оценить базовый уровень. Кандидат
            пишет код в браузере и отправляет на проверку.
          </p>
        </li>
        <li>
